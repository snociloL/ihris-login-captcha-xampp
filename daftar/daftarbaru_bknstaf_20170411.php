    ...
    <td>:</td>
	<td><input class="TEXT" name="userid" type="text" id="userid" maxlength="30" size="30"></td>
    </tr>
    <tr> 
	<td height="10"></td>
	<td></td>
    ...
    <td>:</td> 
	<td><input class="TEXT" name="password" type="text" id="password" maxlength="30" size="30"></td>
	</tr>
    <tr> 
	<td height="10"></td>
	<td></td>
