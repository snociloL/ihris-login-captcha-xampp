	...
	</strong></font><br> </td><?php */?>
    <td td height="10" colspan="3"></td>
	<td></td>
	</tr>
...
<?php	
	...
	$nostaf_admin = isset($_POST['nostaf_admin'])?$_POST['nostaf_admin']:'nostaf_admin'; 
		if($nostaf_admin == 'nostaf_admin')$nostaf_admin = isset($_GET['nostaf_admin'])?$_GET['nostaf_admin']:''; 

		$flag = isset($_POST['flag'])?$_POST['flag']:'flag'; 
		if($flag == 'flag')$flag = isset($_GET['flag'])?$_GET['flag']:''; 
		
		
		//echo $flag.'<<';


	$sql_data1 =" SELECT USERID_UMMAIL
				  FROM SN_VW_ATT_STAFF
                  WHERE NOGAJI_POHON='".$nostaf_admin."'
				";
	//echo $sql_data1.'<br/>';	
	$sql_data1a = ociparse($r,$sql_data1);
	ociexecute($sql_data1a,OCI_DEFAULT);
	if (ocifetch($sql_data1a))
		{
			$user_id = ociresult($sql_data1a,"USERID_UMMAIL");
...
?>
    ...
    <td>:</td>
	<td><input class="TEXT" name="userid" type="text" id="userid" maxlength="30" size="30" value="<?php echo $user_id ?>"  required>
	</td>
    </tr>
    <tr> 
	<td height="10"></td>
...
<?php }?>
  ...
  <td></td>
  <td>1.&nbsp;Min 8 char
    <br>2.&nbsp;Mengandungi sekurang-kurangnya 1 nombor dan 1 alphabet
    <br>3.&nbsp;Campuran sekurang-kurangnya 1 karakter huruf kecil dan 1 karektor huruf besar
  </td>
</tr>
	...
	<input name="nostaf_admin" type="hidden" id="nostaf_admin" value="<?php echo $nostaf_admin ?>">
