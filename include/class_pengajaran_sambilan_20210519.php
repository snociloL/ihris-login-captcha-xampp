...
'sokong_kptj_ajar' => $sokong_kptj_ajar,
   ...
   $kategorijawatan[] = OCIResult($sql_data1a,"PSH_KATEGORI_JAWATAN");
	...
	$DataGra1=" SELECT RA_PASSPORT, RA_PDET_MONTHLY_SALARY, PL_NOGAJI
				FROM VW_GRA_ACTIVE
...
// echo $gaji_ra.'<br><br>';
	...
	if($nokp_ra)
	{
	$str.=  'GRA (GRADUATE RESEARCH ASSISTANT)';	
	}
	elseif($nokp_stud)
	{
	$str.=  'PELAJAR UM';	
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://printis-uat.um.edu.my/sitsvision/wrd/SIW_RWS/HRIS-WSF-04/STU_NINO/'.$no_kp,
...
//echo $response;
				...
				$nostaf_penyelia_stud =	@$data['EXCHANGE']['STU']['STU.SRS'][0]['SPR']['SPR.CAMS'][0]['RDX']['RDX.SRS'][0]['RDX_PRSC.RDX.SRS'];
		...
		return array
		   ...
		   'namastudent' => @$namastudent,
			...
			'ktrgn_fact' => @$ktrgn_fact,
				'emel_1' => @$emel_1, 
				'emel_2' => @$emel_2,
	   'nostaf_penyelia_stud' => @$nostaf_penyelia_stud,
			);	
