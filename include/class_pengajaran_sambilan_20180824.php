...
//	echo $sql_data.'<br/>';				
	...
	$sql_1 = " 	SELECT PSH_NORUJUK_PENGAJAR, 
				...
				AND PSH_SESI= '".$pilihansesi."'
				AND PSH_KOD_KURSUS = '".$pilihanKursus."'
				UNION
...
//	$pilihan=str_replace('/','',$pilihan);
	...
	public static function DataSenaraiJabatan($kodjbtadmin,$pilihan,$flag,$pilihansemester)
	{
	$str = '';
	global $c;
...
'sokong_kptj_ajar' => $sokong_kptj_ajar,
   ...
   $kategorijawatan1 [] = ociresult($sql_data1a,"PSH_KATEGORI_JAWATAN");
	...
	public static function DataStatistikKursus($no_staff,$status,$kod_kursus)
	{
	global $c;
	...
	{
		$cond2="AND PSH_KOD_KURSUS='".$kod_kursus."'";	
	}
	...
	public static function DataStatistikKursusDtl($no_staff,$kodkursus,$semester,$sesi)
	{
	global $c;
	...
	$DataPengajar=" SELECT PSH_ID,PSH_SESI,PSH_JABATAN_AJAR,PSH_JAWATAN,
