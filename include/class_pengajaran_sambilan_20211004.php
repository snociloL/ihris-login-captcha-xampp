...
'sokong_kptj_ajar' => $sokong_kptj_ajar,
   ...
   $nostaf_penyelia = OCIResult($DataGra1a,"PL_NOGAJI");
    ...
    public static function DataNamaPenyelia($nostaff_penyelia,$nostaff_penyelia_for)
	{
	global $c;
	...
	oci_free_statement($DataGraData1a);
        ...
        $DataGraData2=" SELECT NAMA_POHON
                        FROM SN_VW_ATT_STAFF
                        WHERE NOGAJI_POHON  = '".$nostaff_penyelia_for."'
                      ";
...
class MPS_Senarai
    ...
    public static function  SenaraiHonorium($kod_hono)
	{
		...
		$str.=	'<select class="form-control input-sm" name="kod_hono" id="kod_hono" required>';
