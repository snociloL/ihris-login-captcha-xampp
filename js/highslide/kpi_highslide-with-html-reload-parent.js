...
marginTop : 15,
marginBottom : 15,
zIndexCounter : 900, // adjust to other absolutely positioned elements
...
// HTML extension
printText : 'Print',
printHref : 'ct_main_pgw_viewprint.php',
...
getSelfRendered : function() {
	var s =	
		...
		//+   '<li class="highslide-print"><a href="#" onclick="hs.print(this)">'+ hs.printText +'</a></li>'
...
genContainer : function () {
	if (!hs.container) {
		hs.container = hs.createElement('div', 
			null, 
			{ position: 'left', left: 0, top: 0, width: '100%', zIndex: hs.zIndexCounter }, 
			document.body,
			true
		);
...
var kod_ptj=document.getElementById('kod_ptj').value;
var kod_jbt=document.getElementById('kod_jbt').value;
var kump_jawat=document.getElementById('kump_jawat').value;
var kump_rsps=document.getElementById('kump_rsps').value;
var sys_year=document.getElementById('sys_year').value;
window.location.href='pms_pentadbir_bsm_lap_rsps.php?kod_ptj='+kod_ptj+'&kod_jbt='+kod_jbt+'&kump_jawat='+kump_jawat+'&kump_rsps='+kump_rsps+'&sys_year='+sys_year+'&flg_parent=1';
}
